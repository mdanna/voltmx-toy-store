define(['./Inherits', './NativeController'], function(Inherits, NativeController) {
	...
	NativeControllerAndroid.prototype.onBeginningOfSpeechAndroid = function() {
		try {
			...
			if (this.componentInstance.onBeginningOfSpeech !== undefined && this.componentInstance.onBeginningOfSpeech !== null && typeof this.componentInstance.onBeginingOfSpeech === 'function') {
	...
	NativeControllerAndroid.prototype.onRmsChangedAndroid = function(v) {
		try {
			...
			if (this.componentInstance.onRmsChanged !== undefined && this.componentInstance.onRmsChanged !== null && typeof this.componentInstance.onRmsChanged === 'function') {
	...
	NativeControllerAndroid.prototype.onBufferReceivedAndroid = function(bytes) {
		try {
			...
			if (this.componentInstance.onBufferReceived !== undefined && this.componentInstance.onBufferReceived !== null && typeof this.componentInstance.onBuffereReceived === 'function') {
	...
	NativeControllerAndroid.prototype.onEndOfSpeechAndroid = function() {
		try {
			...
			if (this.componentInstance.onEndOfSpeech !== undefined && this.componentInstance.onEndOfSpeech !== null && typeof this.componentInstance.onEndOfSpeech === 'function') {
	...
	NativeControllerAndroid.prototype.onEventAndroid = function(i, bundle) {
		try {
			...
			if (this.componentInstance.onEvent !== undefined && this.componentInstance.onEvent !== null && typeof this.componentInstance.onEvent === 'function') {
	...
	NativeControllerAndroid.prototype.stopAndroidRecognition = function() {
		try {
			...
			this._text = "";
			this.componentInstance.view.imgGif.isVisible = false;
			this.componentInstance.view.flxAnim.isVisible = false;
			//this.componentInstance.view.flxMicrophone.isVisible = true;
			this.componentInstance.view.centerX = this.componentInstance._centerXSet + "%";
			this.componentInstance.view.width = ((this.componentInstance._frameWidth / this.componentInstance._screenWidth) * 100) + "%";
	...
	NativeControllerAndroid.prototype.partialResults = function(text) {
		try {
			...
			if (this.componentInstance.partialSpeechResults !== undefined && this.componentInstance.partialSpeechResults !== null && typeof this.componentInstance.partialResults === 'function') {
